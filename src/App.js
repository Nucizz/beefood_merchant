...
export default function App() {
  ...
  function ProtectedRoute({ allow, redirectPath = "/login", children }) {
    if (!allow) {
    ...
    <Router>
      <Routes>
        <Route
          path="/"
          element={
            merchant ? <Navigate to="/dashboard" /> : <Navigate to="/login" />
          }
        />
        ...
        <Route
          ...
          element={<AdminMerchant page={"Add Merchant"} />}
        ></Route>

        <Route
          path="/admin/verifyhalal"
          element={<AdminMerchant page={"Verify Halal"} />}
        ></Route>

        <Route path="/admin/feedback" element={<FeedbackLayout />}></Route>
        ...
        <Route
          path="*"
          element={<Error code="404" description="Page Not Found!" />}
        />
      </Routes>
    </Router>
  );
